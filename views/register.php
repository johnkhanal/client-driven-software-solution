				...
				<div class="card my-4 p-4 bg-light">
					<div class="card-body">
						...
						<form method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-md-6 mb-4">
									<input type="text" class="form-control" name="name" placeholder="Fullname / Company name" required >
								</div>
								<div class="col-md-6 mb-4">
								...
								<div class="col-md-6 mb-4">
									<input type="text" class="form-control" name="secondary_contact" placeholder="Secondary contact number" >
								</div>
								<div class="col-md-6 mb-4">
						...
						<div class="mt-4 text-muted">
							Already registered? Go to <a href="login">Login Page</a>
						</div>
					</div>
				</div>
			</div>
