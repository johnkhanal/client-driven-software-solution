					...
					<div class="col-lg-8 mx-auto">
						<div class="p-5">
							...
							<div class="text-center">
								<h1 class="h4 text-gray-900 mb-5">Edit Category</h1>
							</div>
							...
							<form class="user" method="POST" action="">
								...
								<div class="row form-group">
									...
									<input type="text" class="form-control form-control-user col-md-9" name="category_name" value="<?php echo $cat['category_name'] ?>">
								</div>
